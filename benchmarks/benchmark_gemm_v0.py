...
from gemm_v0 import _kernel_host_gemm_v0
...
def benchmark_gemm_v0():
    ...
    for M in sizes_M:
        ...
        compiled = cute.compile(_kernel_host_gemm_v0, a_, b_, c_, d_)
    ...
    plt.plot(results["size_M"], results["kernel_v0"], marker="o", label="Custom CuTe DSL Kernel (v0)")
    ...
    plt.tight_layout()
    plt.savefig("benchmarks/figures/benchmark_gemm_v0.png", dpi=600, bbox_inches="tight")
