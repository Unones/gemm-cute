...
def _kernel_gemm_v3(
    ...
    for k in cutlass.range(nb_tiles_k):
        ...
        # if tidx==16 and bidx==0 and bidy==0 and k ==0:
        #     cute.printf("Coordinates for tidx 16")
        #     cute.print_tensor(tCcA, verbose=True)
        # if tidx==17 and bidx==0 and bidy==0 and k==0:
        #     cute.printf("Coordinates for tidx 17")
        #     cute.print_tensor(tCcA, verbose=True)
        # if tidx==18 and bidx==0 and bidy==0 and k==0:
        #     cute.printf("Coordinates for tidx 18")
        #     cute.print_tensor(tCcA, verbose=True)
        # if tidx==19 and bidx==0 and bidy==0 and k==0:
        #     cute.printf("Coordinates for tidx 19")
        #     cute.print_tensor(tCcA, verbose=True)
...
def _kernel_host_gemm_v3(
    ...
    nb_elems_per_thr_mk = nb_elems_mk // nb_theads_per_block
    ...
    cA = cute.make_identity_tensor((M, K))
...
def gemm_v3(
    ...
    _kernel_host_gemm_v3(a_, b_, c_, d_)
